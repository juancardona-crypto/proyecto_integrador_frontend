    ...
    <footer className="bg-gray-900 text-gray-300 py-10 mt-16">
      <div className="max-w-7xl mx-auto px-6 grid grid-cols-2 md:grid-cols-4 gap-8"> 
        ...
        <div>
          ...
          <ul className="mt-3 text-sm space-y-2">
            <li>Email: <a href="mailto:soporte@bagify.com" className="hover:text-white">soporte@EldenNoir.com</a></li>
          ...
          <div className="mt-6"> 
            ...
            <div className="flex space-x-4">  
              <a href="https://www.instagram.com/03_ssh_" target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-white transition-colors duration-300">
                <FaInstagram className="h-6 w-6" />  
              </a>
              <a href="https://www.facebook.com/SantiagoSerna" target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-white transition-colors duration-300">
                <FaFacebookF className="h-6 w-6" />  
              </a>
              <a href="https://www.twitter.com/SantiagoSerna" target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-white transition-colors duration-300">
