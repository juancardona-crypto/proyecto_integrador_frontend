...
export default function Navbar() {
  ...
  return (
    <nav className="w-full border-b bg-rose-950 md:fixed">
      <div className="max-w-7xl mx-auto h-16 flex items-center justify-between p-4">
        ...
        {isMobile && (
          <div className="md:hidden relative">
            ...
            <button 
              onClick={toggleMenu}
              className="text-gray-900 hover:bg-transparent hover:text-black px-4 py-2 rounded-md font-medium"
            >
